...
[<assembly: AssemblyTitleAttribute("shapito.Tests")>]
[<assembly: AssemblyProductAttribute("shapito")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "shapito.Tests"
    let [<Literal>] AssemblyProduct = "shapito"
